...
MODEL_NAME = "lap_time_ranking"
MODEL_DESCRIPTION = "Regressao de tempo de volta com ranking de pilotos."
...
def main() -> None:
    ...
    if settings.output.register_mlflow and _init_mlflow(
        ...
        with mlflow.start_run(run_name="lap_time_ranking", log_system_metrics=True) as run:
            tags = {
