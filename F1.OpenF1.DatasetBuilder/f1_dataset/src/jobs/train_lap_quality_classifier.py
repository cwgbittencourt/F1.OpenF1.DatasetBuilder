...
MODEL_NAME = "lap_quality_classifier"
MODEL_DESCRIPTION = "Classifica qualidade de volta (boa vs ruim)."
...
def main() -> None:
    ...
    if settings.output.register_mlflow and _init_mlflow(
        ...
        with mlflow.start_run(run_name="lap_quality_classifier", log_system_metrics=True) as run:
            tags = {
